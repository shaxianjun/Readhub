...
/***/ function(module, exports, __webpack_require__) {
	...
	var _networkApi = __webpack_require__(33);
	...
	exports.default = {
	  ...
	  convertTime: _util2.default.convertTime,
	  fetchData: _networkApi2.default.fetchData,
...
/***/ function(module, exports) {
	...
	var fetchData = {
	  ...
	  convertTime: function convertTime(dateTimeStamp) {
	    var minute = 1000 * 60;
	    var hour = minute * 60;
	    var day = hour * 24;
	    var halfamonth = day * 15;
	  ...
	  asyncLoadData: function () {
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(type, lastCursor) {
	      var urlParam, ret1, dataJson, jsonStr, i, stamp;
	      return regeneratorRuntime.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            ...
	            case 3:
	              ret1 = _context2.sent;
	              dataJson = JSON.parse(ret1.data.data).data;
	              jsonStr = JSON.stringify(dataJson);
	
	              //转换时间格式
	
	              for (i = 0; i < dataJson.length; i++) {
	                stamp = new Date(dataJson[i].publishDate).getTime();
	    ...
	    function asyncLoadData(_x2, _x3) {
